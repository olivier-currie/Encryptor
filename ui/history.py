...
class History(ttk.Frame):
    def __init__(self, parent, username, entries, show_welcome, show_dashboard, show_account_info):
        ...
        cols=("inputfile", "outputfile", "action", "timestamp")
        self.tree = ttk.Treeview(tree_frame, columns=cols, show="headings", height=15)
        self.tree.heading("inputfile", text="Input File")
        self.tree.heading("outputfile", text="Output File")
        self.tree.heading("action", text="Action")
        self.tree.heading("timestamp", text="Timestamp")
        self.tree.column("inputfile", width=150)
        self.tree.column("outputfile", width=150)
